...
class _AuthScreenState extends State<AuthScreen>
  ...
  late Animation<double> _animationTextRotale;

  void setupAnimation(){
    _animationController = AnimationController(vsync: this,duration: defaultDuration);
    _animationTextRotale = Tween<double>(begin: 0,end: 90).animate(_animationController);
  }
  void updateView(){
    setState(() {
                  ...
                  left:_isShowSignUp ? 0 : _size.width * 0.44-80,
                    child: AnimatedDefaultTextStyle(
                      ...
                      child: Transform.rotate(
                        angle: -_animationTextRotale.value * pi /180,
              ...
              AnimatedPositioned(
                  ...
                  right:_isShowSignUp ? _size.width * 0.44-80 : 0,
                    child: AnimatedDefaultTextStyle(
                      ...
                      child: Transform.rotate(
                        angle:(90 - _animationTextRotale.value) * pi/180 ,
